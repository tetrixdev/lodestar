...
class ReviewFunnelTest extends TestCase
{
    ...
    public function test_flag_stale_sections_marks_only_sections_covering_changed_files(): void
    {
        ...
        $fileA = $comparison->files()->create(['path' => 'a.php', 'status' => 'modified', 'position' => 0]);
        $comparison->files()->create(['path' => 'b.php', 'status' => 'modified', 'position' => 1]);
    ...
    public function test_deliverable_coverage_gate_blocks_human_review_until_files_covered(): void
    {
        ...
        $file = $review->comparisons()->create(['position' => 0])->files()->create(['path' => 'a.php', 'status' => 'modified', 'position' => 0]);
