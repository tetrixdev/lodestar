...
class McpReferenceController extends Controller
{
    ...
    private const EXAMPLES = [
        ...
        'create_review' => '{ "id": 7, "url": "https://.../reviews/7", "comparisons": [{ "repository": "jfbauer/lodestar", "base_ref": "main", "head_ref": "feat/x", "files": 9 }], "linked_tasks": 1, "coverage": {...}, "next": "Group coverage.uncovered into sections..." }',
        ...
        'get_review' => '{ "id": 7, "title": "...", "status": "in_review", "comparisons": [{ "repository": "...", "base_ref": "...", "head_ref": "...", "files": [...] }], "coverage": {...}, "tasks": [...] }',
