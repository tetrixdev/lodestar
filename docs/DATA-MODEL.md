...
| base_branch | string | nullable | What a deliverable review diffs against (`base_branch...deliverable.branch`); task reviews use their `review_comparisons`' base/head SHAs instead. |
